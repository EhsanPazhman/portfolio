<div>
    <section class="max-w-6xl mx-auto py-16">
        <div class="flex flex-col items-center mb-12">
            ...
            <h1 class="text-4xl font-black text-gray-900 tracking-tighter">Featured Projects</h1>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($owner->profile->projects as $project)
                <div
                    ...
                    <div class="p-6">
                        <h3 class="font-black text-xl text-gray-900 mb-2 tracking-tight">
                            {{ $project->title }}</h3>
                        ...
                        <div
                            ...
                            <a href="{{ $project->demo_url }}"
                                class="text-[10px] font-bold uppercase tracking-widest text-gray-900 flex items-center gap-2">
